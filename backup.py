...
def main():
   ...
   # layout="wide",
    ...
    urls = ["https://docs.python.org/3.9/"]  # Example URL list, you can replace it with your desired URLs
    ...
    with st.spinner("Processing..."):
        ...
        st.info(f"URLs processed successfully in {processing_time:.2f} seconds.")  # Tampilkan waktu pemrosesan
